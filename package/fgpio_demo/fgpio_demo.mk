...
ifdef BR2_PACKAGE_QAPPLAUNCHER
QAPP_ADDER=python $(BR2_EXTERNAL)/package/qapplauncher/qapp_adder.py $(TARGET_DIR) /opt/QAppConfig/settings/default.ini /opt/fgpio_demo/run_demo.py
endif

define FGPIO_DEMO_INSTALL_TARGET_CMDS
	mkdir -p $(TARGET_DIR)/opt/fgpio_demo
	cp -dpfr $(@D)/logo.png $(TARGET_DIR)/opt/fgpio_demo/logo.png
