...
BROADCOM_BLUETOOTH_SITE = $(call github,hmallat,broadcom-bluetooth,$(BROADCOM_BLUETOOTH_VERSION))
BROADCOM_BLUETOOTH_LICENSE = APACHE-2.0

define BROADCOM_BLUETOOTH_BUILD_CMDS
	$(TARGET_CC) $(TARGET_CFLAGS) $(@D)/broadcom-bluetooth/brcm_patchram_plus.c -o $(@D)/brcm_patchram_plus
endef
